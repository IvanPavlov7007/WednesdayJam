...
public class DangerousNode : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PlayerDiscreteInput.Instance.GetComponent<CharacterMover>().onCharacterMoved += onPlayerMoved;
    }
    ...
    void hitPlayer()
    {
        PlayerDiscreteInput.Instance.GetComponent<CharacterStates>().hitCharacter();
    }
